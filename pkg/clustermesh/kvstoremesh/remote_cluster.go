...
// drainGracePeriod is the grace period to allow Cilium agents to disconnect
// before deleting all cached data. This allows to reduce the overhead on etcd,
// and prevents issues in case KVStoreMesh is being disabled. Configurable to
// allow overriding it from tests.
var drainGracePeriod = 3 * time.Minute
